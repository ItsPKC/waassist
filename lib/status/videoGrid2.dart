...
class VideoGrid2 extends StatefulWidget {
  final String _path;
  final Function pageNumberSelector;
  VideoGrid2(this._path, this.pageNumberSelector);

  @override
  _VideoGrid2State createState() => _VideoGrid2State();
}

class _VideoGrid2State extends State<VideoGrid2> {
      ...
      child: RefreshIndicator(
        ...
        child: (itemList.isNotEmpty)
            ? GridView(
                ...
                children: [
                  ...itemList.mapIndexed((index, element) => Container(
