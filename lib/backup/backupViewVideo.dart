...
class BackupViewVideo extends StatefulWidget {
  // ignore: prefer_typing_uninitialized_variables
  final _path;
  final _itemList;
  final _index;
  BackupViewVideo(this._path, this._itemList, this._index);

  @override
  _BackupViewVideoState createState() => _BackupViewVideoState();
}

class _BackupViewVideoState extends State<BackupViewVideo> {
