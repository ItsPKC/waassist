...
class BackupViewImage extends StatefulWidget {
  // ignore: prefer_typing_uninitialized_variables
  final _path;
  final _imageList;
  final _index;
  BackupViewImage(this._path, this._imageList, this._index);

  @override
  _BackupViewImageState createState() => _BackupViewImageState();
}

class _BackupViewImageState extends State<BackupViewImage> {
